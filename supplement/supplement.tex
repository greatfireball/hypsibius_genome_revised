...
\lstset{basicstyle=\ttfamily\footnotesize,backgroundcolor=\color{light-gray},frame=single}
...
\author{\normalsize Felix Bemm\textsuperscript{1}, Clemens Leonard Weiß\textsuperscript{1}, Jörg Schultz\textsuperscript{2,3}, Frank Förster\textsuperscript{2,3,*}\\[5em]
  \scriptsize \textsuperscript{1} Max-Planck-Institute for Developmental Biology, Department Molecular Biology, 72076 Tübingen, Germany\\
  \scriptsize \textsuperscript{2} Center for Computational and Theoretical Biology, Campus Nord, University of Würzburg, 97074 Würzburg, Germany\\
  \scriptsize \textsuperscript{3} Department for Bioinformatics, Biozentrum, University of Würzburg, 97074 Würzburg, Germany\\
  \scriptsize \textsuperscript{*} To whom correspondence should be addressed: \href{mailto:frank.foerster@uni-wuerzburg.de}{frank.foerster@uni-wuerzburg.de}}
\date{}
